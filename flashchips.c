...
const struct flashchip flashchips[] = {
...

	{
		...
		.bustype	= BUS_PARALLEL,
		.id.type	= ID_JEDEC,
		.id.manufacture	= SYNCMOS_MVC_ID,
		.id.model	= MVC_V29C51000B,
		.total_size	= 64,
		.page_size	= 512,
		.feature_bits	= FEATURE_EITHER_RESET,
		.tested		= TEST_UNTESTED,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= NANTRONICS_ID_NOPREFIX,
		.id.model	= NANTRONICS_N25S10,
		.total_size	= 128,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_UNTESTED,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= PMC_ID,
		.id.model	= PMC_PM25LD010,
		.total_size	= 128,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_OK_PREW,
...

	{
		...
		.name		= "Pm25LV010",
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RES2, /* The continuation code is transferred as the 3rd byte m( */
		.id.manufacture	= PMC_ID_NOPREFIX,
		.id.model	= PMC_PM25LV010,
		.total_size	= 128,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_OK_PREW,
...

	{
		...
		.id.type	= ID_JEDEC,
		.id.manufacture	= PMC_ID_NOPREFIX,
		.id.model	= PMC_PM39F010,	/* Pm39LV010 and Pm39F010 have identical IDs but different voltage */
		.total_size	= 128,
		.page_size	= 4096,
		.feature_bits	= FEATURE_ADDR_2AA | FEATURE_EITHER_RESET,
		.tested		= TEST_OK_PREW,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= PUYA_ID,
		.id.model	= PUYA_P25Q05H,
		.total_size	= 64,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_EITHER | FEATURE_WRSR_EXT2 |
				  FEATURE_OTP | FEATURE_QIO,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= SANYO_ID, /* See flashchips.h */
		.id.model	= SST_SST25WF020A,
		.total_size	= 256,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_UNTESTED,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RES2,
		.id.manufacture	= SANYO_ID,
		.id.model	= SANYO_LE25FU106B,
		.total_size	= 128,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_UNTESTED,
...

	{
		...
		.bustype	= BUS_PARALLEL,
		.id.type	= ID_82802AB,
		.id.manufacture	= SHARP_ID,
		.id.model	= SHARP_LH28F008BJ__PB,
		.total_size	= 1024,
		.page_size	= 64 * 1024,
		.tested		= TEST_OK_PREW,
		.probe_timing	= TIMING_ZERO,
...

	{
		...
		.bustype	= BUS_PARALLEL,
		.id.type	= ID_JEDEC,
		.id.manufacture	= TI_OLD_ID,
		.id.model	= TI_TMS29F002RB,
		.total_size	= 256,
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q128_V,
		.total_size	= 16384,
		.page_size	= 256,
		/* supports SFDP */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q128_V_M,
		.total_size	= 16384,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_OTP | FEATURE_QPI_SRP,
		.dummy_cycles	= { .qpi_read_params = { 2, 4, 6, 8 } },
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q128_W,
		.total_size	= 16384,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q128_DTR,
		.total_size	= 16384,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_OTP | FEATURE_QPI_SRP,
		.dummy_cycles	= { .qpi_read_params = { 2, 4, 6, 8 } },
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q16JV_M,
		.total_size	= 2048,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_EITHER | FEATURE_WRSR_EXT2 |
				  FEATURE_WRSR2 | FEATURE_WRSR3 | FEATURE_OTP |
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q256_V,
		.total_size	= 32768,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q256JV_M,
		.total_size	= 32768,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q256_W,
		.total_size	= 32768,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q256_DTR,
		.total_size	= 32768,
		.page_size	= 256,
		/* supports SFDP */
		/* OTP: 1024B total, 256B reserved; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q32JW_M,
		.total_size	= 4096,
		.page_size	= 256,
		/* OTP: 768B total; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
		/* QPI enable 0x38, disable 0xFF */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q512JV,
		.total_size	= 64 * 1024,
		.page_size	= 256,
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25R512NW,
		.total_size	= 65536,
		.page_size	= 256,
		/* supports SFDP */
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q512NW_IM,
		.total_size     = 64 * 1024,
		.page_size      = 256,
		.feature_bits   = FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_WRSR3 |
				  FEATURE_OTP | FEATURE_4BA | FEATURE_QPI_SRP,
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= WINBOND_NEX_ID,
		.id.model	= WINBOND_NEX_W25Q64JW_M,
		.total_size	= 8192,
		.page_size	= 256,
		/* OTP: 256B total; read 0x48; write 0x42, erase 0x44, read ID 0x4B */
		/* QPI enable 0x38, disable 0xFF */
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= XTX_ID,
		.id.model	= XTX_XT25F02E,
		.total_size	= 256,
		.page_size	= 256,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= ZETTADEVICE_ID,
		.id.model	= ZETTADEVICE_ZD25D20,
		.total_size	= 256,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN,
		.tested		= TEST_UNTESTED,
...

	{
		...
		.id.type	= ID_SPI_RDID,
		.id.manufacture	= ZETTADEVICE_ID,
		.id.model	= ZETTADEVICE_ZD25LQ128,
		.total_size	= 16384,
		.page_size	= 256,
		.feature_bits	= FEATURE_WRSR_WREN | FEATURE_WRSR2 | FEATURE_WRSR_EXT2 |
				  FEATURE_OTP | FEATURE_QPI_SRP,
...

	{
		...
		.bustype	= BUS_SPI,
		.id.type	= ID_SPI_SFDP,
		.id.manufacture	= GENERIC_MANUF_ID,
		.id.model	= SFDP_DEVICE_ID,
