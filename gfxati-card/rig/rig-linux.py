...
CHIPS = [
	...
	(32, "AT45DB011D",   "128K", "AT45DB011D",     "full",   "the raw-stream transport (CNTL2 opcode + window bytes): buffer fill 84H, commit 88H, D7 status, page/block erases"),
	...
	(39, "AT49F001N",    "128K", "AT49F001N",      "full",   "DB entry added (1F 04, the bottom-boot twin)"),
	(40, "AT49F001T",    "128K", "AT49F001T",      "full",   "DB entry added (1F 05, the top-boot twin)"),
	(41, "AT49LV010",    "128K", "AT49LV010",      "full",   "DB entry added (1F 17, the 3V sibling)"),
	(42, "MX29F001B",    "128K", "MX29F001B",      "full",   "JEDEC parallel, C2 19; the first parallel master proof"),
	(43, "MX29F001T",    "128K", "MX29F001T",      "full",   "JEDEC parallel, C2 18"),
	(44, "MX29F512",     "64K",  "M29F512B",       "full",   "the model row carries the ST sibling id (20 24) - identified via the DB M29F512B entry"),
	...
	(47, "SST39SF512",   "64K",  "SST39SF512",     "full",   "JEDEC parallel, BF B4; the byte-family proof"),
	(48, "SST39SF010",   "128K", "SST39SF010",     "full",   "DB entry added (BF B5)"),
	(49, "SST39VF512",   "64K",  "SST39VF512",     "full",   "JEDEC parallel, BF D4"),
	(50, "SST39VF010",   "128K", "SST39VF010",     "full",   "JEDEC parallel, BF D5"),
	(51, "SST45LF010",   "128K", "SST45LF010",     "full",   "DB entry added (BF 42, the FWH-quirk part)"),
]
