...
const struct gfxati_flash_chip gfxati_flash_chips[] = {
	...
	{ "M25P20", 256 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0x20, 0x12, 0 }, 2, 0, GFXATI_ERASE_64K, 0 },
	{ "M25P40", 512 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0x20, 0x13, 0 }, 2, 0, GFXATI_ERASE_64K, 0 },
	...
	{ "SST25VF020", 256 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xBF, 0x25, 0x4A }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_32K | GFXATI_ERASE_64K, 0 },
	...
	{ "W25P10", 128 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x30, 0 }, 2, 0, GFXATI_ERASE_64K | GFXATI_ERASE_CHIP, GFXATI_Q_NO_RDID },
	{ "W25P20", 256 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x31, 0 }, 2, 0, GFXATI_ERASE_64K | GFXATI_ERASE_CHIP, GFXATI_Q_NO_RDID },
	{ "W25P40", 512 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x32, 0 }, 2, 0, GFXATI_ERASE_64K | GFXATI_ERASE_CHIP, GFXATI_Q_NO_RDID },
	{ "W25Q40", 512 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x40, 0x13 }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_32K | GFXATI_ERASE_64K, 0 },
	{ "W25X10", 128 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x30, 0x10 }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_64K, 0 },
	{ "W25X20", 256 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x30, 0x11 }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_64K, 0 },
	{ "W25X40", 512 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x30, 0x13 }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_64K, 0 },
	{ "W25X80", 1024 * 1024, 256, GFXATI_SPI, GFXATI_ID_RDID, { 0xEF, 0x30, 0x14 }, 3, 0, GFXATI_ERASE_4K | GFXATI_ERASE_64K, 0 },
